  ...
  return (
    <div className="h-auto w-full bg-white rounded-lg p-4 pb-8 shadow-md">
      ...
      <p className="text-base mt-1">
        ...
        world of mobile applications. Explore trends, discover top-performing
        categories, and make informed investment decisions with our interactive
        charts and detailed analytics. Dive into app metrics, user sentiments,
